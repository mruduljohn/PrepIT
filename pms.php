...
<!--Header end-->
    ...
    <div class="container">
<div class="Full_mark">
            <h1 class="display-3">PASS MARK ORIENTED</h1>
        </div>
        <br><br><br>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="sem3Dropdown">
                        <li><a class="dropdown-item" href="resource.php?subject=Latt & firstLetter=P">Linear Algebra and Transform Techniques</a></li>
                        <li><a class="dropdown-item" href="resource.php?subject=DE & firstLetter=P">Digital Electronics</a></li>
                        <li><a class="dropdown-item" href="resource.php?subject=DSA & firstLetter=P">Data Structures and Algorithms</a></li>
                        <li><a class="dropdown-item" href="resource.php?subject=DBMS & firstLetter=P">Database Management System</a></li>
                        <li><a class="dropdown-item" href="resource.php?subject=DCS & firstLetter=P">Discrete Computational Structures</a></li>
                        <li><a class="dropdown-item" href="resource.php?subject=CAO & firstLetter=P">Computer Architecture and Organization</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
